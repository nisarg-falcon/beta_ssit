<?php
/* Smarty version 3.1.33, created on 2020-06-08 17:50:39
  from 'C:\xampp\htdocs\ssit_rebuild\app\views\template\department\electrical.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5ede5e4f467a01_56469644',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b58f3f4fb8b1df3bc713a888341301b5fb03598e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\ssit_rebuild\\app\\views\\template\\department\\electrical.tpl',
      1 => 1591631436,
      2 => 'file',
    ),
  ),
...
function content_5ede5e4f467a01_56469644 (Smarty_Internal_Template $_smarty_tpl) {
?><div id="department" >
            ...
            <div class="labs_swiper">
              <div class="swiper-container labs-swiper">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <img src="<?php echo URLROOT;?>
/public/img/lab/Electrical/1.JPG" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="<?php echo URLROOT;?>
/public/img/lab/Electrical/2.JPG" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="<?php echo URLROOT;?>
/public/img/lab/Electrical/3.JPG" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="<?php echo URLROOT;?>
/public/img/lab/Electrical/4.JPG" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="<?php echo URLROOT;?>
/public/img/lab/Electrical/5.JPG" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="<?php echo URLROOT;?>
/public/img/lab/Electrical/6.JPG" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="<?php echo URLROOT;?>
/public/img/lab/Electrical/7.JPG" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="<?php echo URLROOT;?>
/public/img/lab/Electrical/8.JPG" width="100%"  />
                  </div>
                </div>                       
