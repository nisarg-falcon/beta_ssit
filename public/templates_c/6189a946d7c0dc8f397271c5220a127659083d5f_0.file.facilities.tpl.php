<?php
/* Smarty version 3.1.33, created on 2019-10-12 03:50:45
  from '/home/adminwebpoint/public_html/beta.ssit.co.in/app/views/template/facilities.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5da14d955f9890_61275278',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6189a946d7c0dc8f397271c5220a127659083d5f' => 
    array (
      0 => '/home/adminwebpoint/public_html/beta.ssit.co.in/app/views/template/facilities.tpl',
      1 => 1570844828,
      2 => 'file',
    ),
  ),
...
function content_5da14d955f9890_61275278 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container-fluid">
        ...
        <!-- <div class="rounded" id="labs">
            ...
            <div class="labs-image">
                <figure>
                    <img src="<?php echo URLROOT;?>
/img/civil/lab/surveying/civil-lab-1.jpg" alt="">
                    <img src="<?php echo URLROOT;?>
/img/img2.jpg" alt="">
                    <img src="<?php echo URLROOT;?>
/img/hostel.jpg" alt="">
        ...
        <div id="hostel" class='scroll-start1'>
            <div class="rounded hostel-facility">
                <div class="card bg-dark text-white">
                    <img src="<?php echo URLROOT;?>
/img/hostel.jpg" class="card-img" alt="...">
        ...
        <div id="library" class='scroll-start2'>
            ...
            <div class="card">
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <img src="<?php echo URLROOT;?>
/img/library.jpg" height="100%" class="card-img" alt="...">
                    </div>
                    <div class="col-md-8">
                    <div class="card-body">
            ...
            <div class="lib-facilities">
                ...
                <!-- <img src="<?php echo URLROOT;?>
/img/library.jpg" class="img-fluid" alt=""> -->
                <div class="labs-image">
                    <figure>
                        <img src="<?php echo URLROOT;?>
/img/book-shelf-min.jpg" alt="">
                        <img src="<?php echo URLROOT;?>
/img/IMG_2890-min.JPG" alt="">
                        <img src="<?php echo URLROOT;?>
/img/IMG_2891-min.JPG" alt="">
                        <img src="<?php echo URLROOT;?>
/img/IMG_2903-min.JPG" alt="">
                        <img src="<?php echo URLROOT;?>
/img/IMG_2896-min.JPG" alt="">
                    </figure>
                </div>
            </div>
...
/img/img1.jpg" height="100%" class="card-img" alt="">
            ...
            <div class="card-deck">
                <div class="card">
                    <img src="<?php echo URLROOT;?>
/img/img1.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
        ...
        <p class="h5">Canteen</p>
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <img src="<?php echo URLROOT;?>
/img/img2.jpg" class="d-block w-100" alt="...">
                    </div>
                    ...
                    <div class="content-wrapper">
                        <div class="content department-content">
                            <div class="staff-content">
                                <img src="<?php echo URLROOT;?>
/img/ostc.png" class="img-fluid" alt="">
        ...
        <div id="ground" class="scroll-start5">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                    <img src="<?php echo URLROOT;?>
/img/IMG_2914-min.JPG" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                    <img src="<?php echo URLROOT;?>
/img/img2.jpg" class="d-block w-100" alt="...">
