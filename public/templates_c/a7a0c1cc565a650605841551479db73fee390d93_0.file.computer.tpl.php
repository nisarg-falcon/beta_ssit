...
/public/img/comp/industrial_visit/bisag/iv2.jpg" class="card-img-top" alt="">
                    </a>                    
                  </div>
                  <div class="swiper-slide">
                    <a id="ivbtn2" class="button">
                      <img src="<?php echo URLROOT;?>
/public/img/comp/industrial_visit/bisag/iv1.jpg" class="card-img-top" alt="">
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a id="ivbtn3" class="button">
                      <img src="<?php echo URLROOT;?>
/public/img/comp/industrial_visit/isro/isro1.jpg" class="card-img-top" alt="">
                    </a>
                  </div>
                  <div class="swiper-slide">
...
/public/img/comp/industrial_visit/bisag/iv2.jpg);"></div>
                  <div class="swiper-slide" style="background-image:url(<?php echo URLROOT;?>
/public/img/comp/industrial_visit/bisag/iv1.jpg);"></div>
                  <div class="swiper-slide" style="background-image:url(<?php echo URLROOT;?>
/public/img/comp/industrial_visit/isro/isro1.jpg);"></div>
                  <div class="swiper-slide" style="background-image:url(<?php echo URLROOT;?>
/public/img/comp/industrial_visit/odoo1.jpg);"></div>
                </div>
              </div>              
            </div>        
          </div>
        ...
        <div id="ivmodal" class="eventmodal">
          <div class="modal-content">
              ...
              <img src="<?php echo URLROOT;?>
/img/comp/industrial_visit/bisag/iv2.jpg" class="card-img-top" alt="...">             
          </div>
        </div>
        <div id="ivmodal2" class="eventmodal">
          <div class="modal-content">
              ...
              <img src="<?php echo URLROOT;?>
/img/comp/industrial_visit/bisag/iv1.jpg" class="card-img-top" alt="...">             
          </div>
        </div>
        <div id="ivmodal3" class="eventmodal">
          <div class="modal-content">
              ...
              <img src="<?php echo URLROOT;?>
/img/comp/industrial_visit/isro/isro1.jpg" class="card-img-top" alt="...">             
          </div>
        </div>
        <div id="ivmodal4" class="eventmodal">
          <div class="modal-content">
              ...
              <img src="<?php echo URLROOT;?>
/img/comp/industrial_visit/odoo1.jpg" class="card-img-top" alt="...">             
          </div>
        </div>
            ...
            <div class="labs_swiper">
              <div class="swiper-container labs-swiper">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <img src="<?php echo URLROOT;?>
/public/img/lab/computer/1.jpg" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="<?php echo URLROOT;?>
/public/img/lab/computer/2.jpg" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="<?php echo URLROOT;?>
/public/img/lab/computer/3.jpg" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="<?php echo URLROOT;?>
/public/img/lab/computer/4.jpg" width="100%"  />
                  </div>
                </div>                       
            ...
            <div class="container">
              ...
              <div class="card-grid">
                <a id="modalBtn" class="button">
                    <div class="card">
                        <img src="<?php echo URLROOT;?>
/img/comp/events/comp_hackathon.jpeg" class="card-img-top" alt="...">
                        <div class="card-body">
...
/img/comp/staff/Vijay Gadhavi.jpg" class="card-img-top" alt="...">
              ...
              <a id="modalBtn2" class="button">
                <div class="card">
                    <img src="<?php echo URLROOT;?>
/img/comp/staff/Niraj Thakor.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
              ...
              <a id="modalBtn" class="button">
                <div class="card">
                    <img src="<?php echo URLROOT;?>
/img/comp/staff/Rajul Suthar.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
...
/img/comp/staff/Deepali Mahatma.jpg" class="card-img-top" alt="...">
              ...
              <a id="modalBtn2" class="button">
                <div class="card">
                    <img src="<?php echo URLROOT;?>
/img/comp/staff/Jhanvi mam.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
              ...
              <a id="modalBtn2" class="button">
                <div class="card">
                    <img src="<?php echo URLROOT;?>
/img/comp/staff/Brinda mam.jpeg" class="card-img-top" alt="...">
                    <div class="card-body">
              ...
              <a id="modalBtn2" class="button">
                <div class="card">
                    <img src="<?php echo URLROOT;?>
/img/comp/staff/Rahul Chauhan.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
