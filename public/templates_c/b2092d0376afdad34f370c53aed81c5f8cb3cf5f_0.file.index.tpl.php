<?php
/* Smarty version 3.1.33, created on 2020-04-28 05:58:00
  from 'C:\xampp\htdocs\ssit\app\views\template\index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5ea7a9c86803c0_94350682',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b2092d0376afdad34f370c53aed81c5f8cb3cf5f' => 
    array (
      0 => 'C:\\xampp\\htdocs\\ssit\\app\\views\\template\\index.tpl',
      1 => 1588046081,
      2 => 'file',
    ),
  ),
...
function content_5ea7a9c86803c0_94350682 (Smarty_Internal_Template $_smarty_tpl) {
?><html lang="en">
<head>
    <meta charset="UTF-8">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <div class="scroll-start4" id="events">
            <div class="container course__container">
                ...
                <!-- <img src="img/texture.jpg" class="img-fluid img-responsive" alt="">-->
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <blockquote class="instagram-media" data-instgrm-permalink="https://www.instagram.com/p/B-1naewBUNq/?utm_source=ig_embed&amp;utm_campaign=loading" data-instgrm-version="12" style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);"><div style="padding:16px;"> 
                            <a href="https://www.instagram.com/p/B-1naewBUNq/?utm_source=ig_embed&amp;utm_campaign=loading" style=" background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none; width:100%;" target="_blank"> 
...
>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <iframe src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Fssit.gandhinagar%2Fposts%2F2393420434278640&width=500" width="500" height="719" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
                    </div>
                </div>
            </div>
        </div>
