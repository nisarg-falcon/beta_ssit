<div id="department" >
    <div class="departments_container">
        ...
        <div id="industrial_visit" class="department__container container-fluid scroll-start2">
                ...
                <div class="iv_swiper">
                  <div class="swiper-container iv_gallery_top gallery-top">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" style="background-image: url({URLROOT}/img/img2.jpg);"></div>
                            <div class="swiper-slide" style="background-image: url({URLROOT}/img/img2.jpg);"></div>
                            <div class="swiper-slide" style="background-image: url({URLROOT}/img/img2.jpg);"></div>
                            <div class="swiper-slide" style="background-image: url({URLROOT}/img/img2.jpg);"></div>
                        </div>
