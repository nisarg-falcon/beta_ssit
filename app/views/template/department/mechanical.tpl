           ...
           <div class="branch_info container">
            <div class="branch_txt_container">
                ...
                <div class="branch_link">
                    <a href="{URLROOT}/public/img/mech/borchure/Mechanical-Brochure.pdf"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Brochure</a>
                </div>
            </div>
           </div>
        </div>
          ...
          <div class="labs_container container">
            ...
            <div class="labs_swiper">
              <div class="swiper-container labs-swiper">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <img src="{URLROOT}/public/img/lab/mechanical/1.JPG" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="{URLROOT}/public/img/lab/mechanical/2.JPG" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="{URLROOT}/public/img/lab/mechanical/3.JPG" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="{URLROOT}/public/img/lab/mechanical/4.JPG" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="{URLROOT}/public/img/lab/mechanical/5.JPG" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="{URLROOT}/public/img/lab/mechanical/6.JPG" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="{URLROOT}/public/img/lab/mechanical/7.JPG" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="{URLROOT}/public/img/lab/mechanical/8.JPG" width="100%"  />
                  </div>
                </div>                       
          ...
          <div class="department_info container">
            <h1>Placement</h1>              
              <div class="placement-swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide"><img src="{URLROOT}/public/img/mech/placement/3.jpg" class="img-fluid" alt=""></div>
                  <div class="swiper-slide"><img src="{URLROOT}/public/img/mech/placement/5.jpg" class="img-fluid" alt=""></div>
                  <div class="swiper-slide"><img src="{URLROOT}/public/img/mech/placement/7.jpg" class="img-fluid" alt=""></div>
                  <div class="swiper-slide"><img src="{URLROOT}/public/img/mech/placement/9.jpg" class="img-fluid" alt=""></div>
                  <div class="swiper-slide"><img src="{URLROOT}/public/img/mech/placement/1-2.jpg" class="img-fluid" alt=""></div>
                </div>
              </div>
            </div>        
        </div>
            ...
            <div class="container">
              ...
              <div class="card-grid">
                <a id="modalBtn" class="button">
                    <div class="card">
                        <img src="{URLROOT}/img/mech/event/hands on with ic engine assembly & 3d printer/1-300x225.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <a id="modalBtn2" class="button">
                    <div class="card">
                        <img src="{URLROOT}/img/mech/event/Mechanical2.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
        ...
        <div id="staff" class="container-fluid scroll-start6">
          <div class="container">
            ...
            <div class="card-grid">
              <a id="modalBtn" class="button">
                <div class="card">
                    <img src="{URLROOT}/img/mech/staff/Sanjay Sharma.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
              ...
              <a id="modalBtn2" class="button">
                <div class="card">
                    <img src="{URLROOT}/img/mech/staff/Prof.-Sumitsingh-Sikarwar-200x200.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
              ...
              <a id="modalBtn2" class="button">
                <div class="card">
                    <img src="{URLROOT}/img/mech/staff/Prof.-Vikas-Sheth-200x200.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
              ...
              <a id="modalBtn" class="button">
                <div class="card">
                    <img src="{URLROOT}/img/mech/staff/Prof.-Naresh-Kori-200x200.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
              ...
              <a id="modalBtn2" class="button">
                <div class="card">
                    <img src="{URLROOT}/img/mech/staff/Prof.-Ketan-Shah-200x200.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
              ...
              <a id="modalBtn2" class="button">
                <div class="card">
                    <img src="{URLROOT}/img/mech/staff/Prof.-Brijesh-Pokar-200x200.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
