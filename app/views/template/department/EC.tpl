           ...
           <div class="branch_info container">
            <div class="branch_txt_container">
                ...
                <div class="branch_link">
                    <a href="{URLROOT}/public/img/ec/brochure/EC-BOOKLET-2018_new_2.pdf"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Brochure</a>
                </div>
            </div>
           </div>
        </div>
          ...
          <div class="branch_iv container">
            ...
            <div class="iv_swiper">
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <a id="ivbtn" class="button">
                      <img src="{URLROOT}/public/img/ec/industrial_visit/mundra_port/Adani1.jpg" class="card-img-top" alt="">
                    </a>                    
                  </div>
                  <div class="swiper-slide">
                    <a id="ivbtn2" class="button">
                      <img src="{URLROOT}/public/img/ec/industrial_visit/bisag/BISAG-300x225.jpg" class="card-img-top" alt="">
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a id="ivbtn3" class="button">
                      <img src="{URLROOT}/public/img/ec/industrial_visit/mundra_port/Adani2.jpg" class="card-img-top" alt="">
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a id="ivbtn4" class="button">
                      <img src="{URLROOT}/public/img/ec/industrial_visit/reve_automation/REVE-300x156.jpg" class="card-img-top" alt="">
                    </a>
                    </div>
                </div>
              ...
              <div class="swiper-container gallery-thumbs">
                <div class="swiper-wrapper">
                  <div class="swiper-slide" style="background-image:url({URLROOT}/public/img/ec/industrial_visit/mundra_port/Adani1.jpg);"></div>
                  <div class="swiper-slide" style="background-image:url({URLROOT}/public/img/ec/industrial_visit/bisag/BISAG-300x225.jpg);"></div>
                  <div class="swiper-slide" style="background-image:url({URLROOT}/public/img/ec/industrial_visit/mundra_port/Adani2.jpg"></div>
                  <div class="swiper-slide" style="background-image:url({URLROOT}/public/img/ec/industrial_visit/reve_automation/REVE-300x156.jpg);"></div>
                </div>
              </div>              
            </div>        
          </div>
          ...
          <div class="labs_container container">
            ...
            <div class="labs_swiper">
              <div class="swiper-container labs-swiper">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <img src="{URLROOT}/public/img/lab/E.C/1.JPG" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="{URLROOT}/public/img/lab/E.C/2.JPG" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="{URLROOT}/public/img/lab/E.C/3.JPG" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="{URLROOT}/public/img/lab/E.C/4.JPG" width="100%"  />
                  </div>
                  <div class="swiper-slide">
                    <img src="{URLROOT}/public/img/lab/E.C/5.JPG" width="100%"  />
                  </div>
                </div>                       
          ...
          <div class="department_info container">
            <h1>Placement</h1>              
              <div class="placement-swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide"><img src="{URLROOT}/public/img/ec/placement/BISAG-300x150.png" class="img-fluid" alt=""></div>
                  <div class="swiper-slide"><img src="{URLROOT}/public/img/ec/placement/BLESSING.jpg" class="img-fluid" alt=""></div>
                  <div class="swiper-slide"><img src="{URLROOT}/public/img/ec/placement/electro-1-300x88.jpg" class="img-fluid" alt=""></div>
                  <div class="swiper-slide"><img src="{URLROOT}/public/img/ec/placement/RAVE-300x125.png" class="img-fluid" alt=""></div>
                  <div class="swiper-slide"><img src="{URLROOT}/public/img/ec/placement/TEKSUN.png" class="img-fluid" alt=""></div>
                </div>
              </div>
            </div>        
        </div>
            ...
            <div class="container">
              ...
              <div class="card-grid">
                <a id="modalBtn" class="button">
                    <div class="card">
                        <img src="{URLROOT}/img/ec/events/E.C_RESERCH ACTIVITY.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <a id="modalBtn2" class="button">
                    <div class="card">
                        <img src="{URLROOT}/img/ec/events/E.C_ROBITICS ACTIVITY.JPG" class="card-img-top" alt="...">
                        <div class="card-body">
        ...
        <div id="staff" class="container-fluid scroll-start6">
          <div class="container">
            ...
            <div class="card-grid">
              <a id="modalBtn" class="button">
                <div class="card">
                    <img src="{URLROOT}/img/ec/staff/Prof.-Ravi-Chauhan-200x200.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
              ...
              <a id="modalBtn2" class="button">
                <div class="card">
                    <img src="{URLROOT}/img/ec/staff/Prof.-Gaurang-Patel-200x200.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
              ...
              <a id="modalBtn" class="button">
                <div class="card">
                    <img src="{URLROOT}/img/ec/staff/Prof.-Mihir-Patel-200x200.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
